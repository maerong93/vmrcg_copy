...
add_stylesheet('<link rel="stylesheet" href="'.$dddd2_skin_url.'/style.css?ver=1">', 0);
...
<article id="bo_v" style="width:<?php echo $width; ?>">
    <header>
        <h2 id="bo_v_title">
            ...
            <?php
                ...
                $row = sql_fetch($sql);
            ?>
            SCENE ID: <?php echo $row['sn_scene'];?>
        ...
        <h3>
            <!-- <label for="">오브젝트 명: </label> -->
            <span><?php //echo $view['sn_objectName'] ?></span>
        </h3>
    </header>
    ...
    <section id="bo_v_info">
	    ...
	    <div id="bo_v_top">
            ...
            <?php
                ...
                $row = sql_fetch($sql);
            ?>
            <span class="bo_v_gender" style="<?php if($row['sn_voice']=='male'){ echo "background-color:lightgreen;";}else{ echo "background-color:pink;"; } ?>">
                <?php
                    if($row['sn_voice'] == 'male'){
                        echo "남자환자";
                    }else{
                        echo "여자환자";
                    }
	        ...
	        <ul class="btn_bo_user bo_v_com">
	        	...
	        	<li>
		        	...
		        	<ul class="more_opt is_view_btn"> 
			            <?php if ($update_href) { ?><li><a href="modifyScenario.php?bo_table=free&wr_id=<?php echo $wr_id?>">수정<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li><?php } ?>
			            <?php if ($delete_href) { ?><li><a href="deleteScenario.php?bo_table=free&wr_id=<?php echo $wr_id?>" onclick="del(this.href); return false;">삭제<i class="fa fa-trash-o" aria-hidden="true"></i></a></li><?php } ?>
            ...
            $("#usable1").change(useuse=function(){
                // var data = {
                //     "sn_usable":$("#usable1").val()
                // }
                $.ajax({
                    url:"test.php",
                    //url:"view.php",
    ...
    <section id="bo_v_atc">
        ...
        <!-- 본문 내용 시작 { -->
        <div id="bo_v_con"><?php echo get_view_thumbnail($view['sn_explanation']); ?></div>
    ...
    <?php
    // 코멘트 입출력
    include_once(G5_VMRCG2_PATH.'/view_comment.php');
	?>
</article>
<!-- } 게시판 읽기 끝 -->
