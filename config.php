...
define('G5_VMRCG_DIR',        'vmrcg');
define('G5_VMRCG2_DIR',        'vmrcg2');
...
define('G5_VMRCG_URL',        G5_URL.'/'.G5_VMRCG_DIR);

define('G5_VMRCG2_URL',        G5_URL.'/'.G5_VMRCG2_DIR);
...
define('G5_JSON_URL',       G5_URL.'/'.G5_JSON_DIR);
...
define('G5_VMRCG_PATH',     G5_PATH.'/'.G5_VMRCG_DIR);
define('G5_VMRCG2_PATH',    G5_PATH.'/'.G5_VMRCG2_DIR);
define('G5_DATA_PATH',      G5_PATH.'/'.G5_DATA_DIR);
define('G5_JSON_PATH',      G5_PATH.'/'.G5_JSON_DIR);
